      ...
      <div className="max-w-lg mx-auto mt-16 text-center space-y-6">
        ...
        <Card>
          <CardContent className="pt-5 space-y-3 text-sm">
            ...
            <div className="flex justify-between">
              <span className="text-surface-500">Platform Fee (3%)</span>
        ...
        <div className="flex gap-3 justify-center">
          <Button variant="outline" asChild>
            <Link href="/farmer/invoices">View My Invoices</Link>
          </Button>
          <Button
            onClick={() => {
              setForm(EMPTY_FORM);
  ...
  return (
    <div className="max-w-xl mx-auto space-y-6">
      <div>
        ...
        <h1 className="text-2xl font-bold text-surface-900">Submit Invoice</h1>
        <p className="text-sm text-surface-500 mt-1">
        ...
        <CardContent className="pt-6 space-y-5">
          ...
          <div className="space-y-1.5">
            ...
            <textarea
              ...
              onChange={handleChange}
              className="flex w-full rounded-md border border-surface-300 bg-white px-3 py-2 text-sm text-surface-900 placeholder:text-surface-400 focus:outline-none focus:ring-2 focus:ring-brand-500 resize-none"
            />
          </div>
          ...
          <div className="space-y-1.5">
            ...
            <label className="flex flex-col items-center justify-center gap-2 rounded-lg border-2 border-dashed border-surface-200 p-6 cursor-pointer hover:border-brand-400 hover:bg-brand-50 transition-colors">
              {form.fileName ? (
                <>
