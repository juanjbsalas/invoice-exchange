...
export default function PaymentHistoryPage() {
  ...
  return (
    <div className="space-y-6 max-w-4xl">
                  ...
                  >
                    ...
                    <td className="px-6 py-4 text-right">
                      <Button variant="ghost" size="sm" asChild>
                        <Link href={`/farmer/invoices/${inv.id}`}>View</Link>
                      </Button>
                    </td>
                  </tr>
                ))}
      ...
      {/* Summary */}
      {paid.length > 0 && (
        <div className="rounded-xl border border-surface-200 bg-surface-50 p-5 flex items-center justify-between text-sm">
