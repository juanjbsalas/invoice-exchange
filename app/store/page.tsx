      ...
      {needsConfirmation.length > 0 && (
        <div className="flex items-center justify-between rounded-xl border border-amber-200 bg-amber-50 px-5 py-4">
          ...
          <Button variant="accent" size="sm" asChild>
            <Link href="/store/invoices">Review Now</Link>
          </Button>
        </div>
      )}
          ...
          <CardHeader>
            <div className="flex items-center justify-between">
              ...
              <Button variant="ghost" size="sm" asChild>
                <Link href="/store/invoices" className="flex items-center gap-1">
        ...
        <Card>
          <CardHeader>
            <div className="flex items-center justify-between">
              ...
              <Button variant="ghost" size="sm" asChild>
                <Link href="/store/schedule" className="flex items-center gap-1">
                ...
                return (
                  <tr key={inv.id} className="hover:bg-surface-50 transition-colors">
                    ...
                    <td className="px-6 py-3.5 text-right">
                      <Button variant="ghost" size="sm" asChild>
                        <Link href={`/store/invoices/${inv.id}`}>View</Link>
                      </Button>
                    </td>
                  </tr>
                );
